...
export const MOCK_TICKETS: Ticket[] = [
  {
    ...
    unread: 0,
    client: { name: "Вы", email: "duduruu555@mail.ru", phone: "+7 952 199 09 06" },
    messages: [
      {
        id: 1,
        from: "client",
      ...
      },
      {
        id: 3,
        from: "client",
        text: "Подскажите, есть ли телефон менеджера, к которому можно обратиться напрямую по вопросу средств?",
        time: "2026-04-15T16:37:00",
        files: [],
      },
      {
        id: 4,
        from: "agent",
        text: "Уточняем информацию. В ближайшее время предоставим вам контактный номер — он пригодится, если возникнут какие-либо проблемы.",
        time: "2026-04-15T16:44:00",
        files: [],
      },
      {
        id: 5,
        from: "agent",
        text: "Добрый день! Информируем вас о том, что снятие средств 17 апреля может пройти некорректно в связи с расторжением договора. Просим вас произвести снятие средств в понедельник, 20 апреля.",
        time: "2026-04-16T20:22:00",
        files: [],
      },
    ],
    rating: null,
